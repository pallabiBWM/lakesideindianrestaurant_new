...
const TakeawayMenu = () => {
  ...
  const fetchMenuItems = async () => {
    try {
      const response = await axios.get(`${API}/menu?menu_type=takeaway`);
  ...
  const fetchCategories = async () => {
    try {
      const response = await axios.get(`${API}/categories?menu_type=takeaway`);
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <section
        ...
        data-testid="takeaway-menu-banner"
      >
